...
- Read input: 150,528 × 4 = 602,112 B  
- Read weights: 9,408 × 4 = 37,632 B  
- Write output: 802,816 × 4 = 3,211,264 B  

Total bytes = 602,112 + 37,632 + 3,211,264 = **3,851,008 B** (≈ 3.67 MiB).

### 3. MACs and intensity

From the profile, this layer has **118,013,952** MACs (torchinfo “Mult-Adds”).

Arithmetic intensity = 118,013,952 MACs ÷ 3,851,008 B ≈ **30.6 MAC/B**.

Equivalently, if each MAC is counted as 2 FLOPs: ≈ **61.3 FLOP/B** for the same traffic model.
