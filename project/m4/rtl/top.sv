...
//     top
//     ├── u_if   : \interface  (project/m4/rtl/interface.sv)
//     │              AXI4-Stream slave/master wrapper + backpressure control
//     └── u_core : compute_core (project/m4/rtl/compute_core.sv)
...
module top (
    ...
    // =========================================================================
    // u_core — BGR-to-grayscale + in-range threshold compute engine (1-lane)
