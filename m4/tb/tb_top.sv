...
// Compile (from repo root; uses only project/m4/rtl):
//   iverilog -g2012 -DDUMP_VCD -o project/m4/sim/sim_top.out \
//       project/m4/tb/tb_top.sv project/m4/rtl/top.sv \
//       project/m4/rtl/interface.sv project/m4/rtl/compute_core.sv
// Simulate:
//   cd project/m4/sim && vvp sim_top.out | tee final_run.log
// =============================================================================
...
`endif
        ...
        $display("=============================================================");
        $display("  tb_top : M4 end-to-end co-simulation (AXI4-Stream path)   ");
        $display("=============================================================");
        $display("  DUT    : project/m4/rtl/top.sv");
